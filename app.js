...
const EMBASSY_ACTIVITY_TITLE_TRANSLATIONS = {
  ...
  "Palacio Imperial y Marunouchi": "Imperial Palace and Marunouchi",
  ...
  "Check-out en Tokio y salida a Tokyo Station": "Hotel check-out in Tokyo and transfer to Tokyo Station",
  ...
  "Traslado al Aeropuerto de Hiroshima (HIJ)": "Transfer to Hiroshima Airport (HIJ)",
  "Vuelo Hiroshima -> Haneda (HND)": "Flight from Hiroshima to Haneda (HND)",
  "Traslado Haneda -> hotel en Tokio": "Transfer from Haneda to hotel in Tokyo",
  "Tokio pendientes: Asakusa, Akihabara o Shibuya": "Tokyo pending spots: Asakusa, Akihabara, or Shibuya",
  "Cena de regreso en Shinjuku": "Welcome-back dinner in Shinjuku",
  ...
  "Tokyo Skytree y Solamachi": "Tokyo Skytree and Solamachi",
  "Mañana ligera y check-out": "Light morning and check-out",
  "Traslado al Aeropuerto de Haneda (HND)": "Transfer to Haneda Airport (HND)",
  "Check-in internacional en Haneda": "International check-in at Haneda",
